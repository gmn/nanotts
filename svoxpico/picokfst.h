...
void picokfst_kfstStartPairSearch (picokfst_FST that, picokfst_symid_t inSym,
...
void picokfst_kfstGetNextPair (picokfst_FST that, picoos_int32 * searchState,
...
void picokfst_kfstGetTrans (picokfst_FST that, picokfst_state_t startState, picokfst_class_t transClass,
...
void picokfst_kfstStartInEpsTransSearch (picokfst_FST that, picokfst_state_t startState,
...
void picokfst_kfstGetNextInEpsTrans (picokfst_FST that, picoos_int32 * searchState,
