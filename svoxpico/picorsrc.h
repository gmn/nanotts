...
pico_status_t picorsrc_createVoiceDefinition(picorsrc_ResourceManager that,
...
pico_status_t picorsrc_createVoice(picorsrc_ResourceManager that, const picoos_char * voiceName, picorsrc_Voice * voice);
